  ...
  return (
    <div className="space-y-4 animate-fade-in">
      ...
      <div className="rounded-2xl bg-gradient-to-r from-slate-950 via-slate-900 to-indigo-950 text-white px-5 py-3.5 shadow-lg border border-slate-800/80 flex flex-col md:flex-row items-start md:items-center justify-between gap-3">
        ...
        <div className="grid grid-cols-2 sm:flex sm:items-center gap-2 w-full md:w-auto flex-wrap">
          <button
            ...
            className="px-3 py-2 sm:py-1.5 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 shadow-md shadow-emerald-600/20 transition-all hover:scale-105 active:scale-95 cursor-pointer"
          >
          ...
          <button
            ...
            className="px-3 py-2 sm:py-1.5 bg-gradient-to-r from-rose-600 to-pink-600 hover:from-rose-500 hover:to-pink-500 text-white rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 shadow-md shadow-rose-600/20 transition-all hover:scale-105 active:scale-95 cursor-pointer"
          >
            <PlusCircle className="w-3.5 h-3.5" />
          ...
          <button
            ...
            className="px-3 py-2 sm:py-1.5 bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-400 hover:to-orange-500 text-white rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 shadow-md shadow-amber-500/20 transition-all hover:scale-105 active:scale-95 cursor-pointer"
          >
          ...
          <button
            ...
            className="px-3 py-2 sm:py-1.5 bg-purple-600/30 hover:bg-purple-600/50 text-purple-200 border border-purple-400/30 rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 transition-all hover:scale-105"
          ...
          <div className="col-span-2 sm:col-span-1 flex items-center justify-end gap-2">
            <button
              ...
              className="flex-1 sm:flex-initial p-2 sm:p-1.5 bg-white/10 hover:bg-white/20 text-slate-200 border border-white/15 rounded-xl text-xs transition-all hover:scale-105 flex items-center justify-center gap-1"
              title="Print Statement"
            >
              <Printer className="w-3.5 h-3.5" />
              <span className="sm:hidden font-bold">Print</span>
            </button>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-3 sm:gap-3.5">
        ...
        <div
          onClick={() => onNavigate('income')}
          className="relative overflow-hidden rounded-2xl p-3.5 sm:p-4 bg-gradient-to-br from-emerald-600 via-teal-600 to-emerald-700 text-white shadow-md shadow-emerald-600/15 hover:shadow-lg hover:shadow-emerald-600/25 transition-all duration-200 hover:-translate-y-1 cursor-pointer group flex flex-col justify-between min-h-[115px] sm:min-h-[120px]"
        >
          <div className="flex items-center justify-between mb-1.5">
            <span className="text-[10px] font-black uppercase tracking-wider text-emerald-100">
              Total Inflow
            </span>
            <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-lg bg-white/15 backdrop-blur-xs flex items-center justify-center text-white border border-white/20">
              <TrendingUp className="w-3.5 h-3.5" />
            </div>
          </div>

          <div className="text-lg sm:text-xl xl:text-2xl font-black tracking-tight text-white whitespace-nowrap overflow-hidden text-ellipsis my-1">
            {formatBDT(totalIncome)}
          </div>

          <div className="flex items-center justify-between pt-2 border-t border-white/15 text-[10px] sm:text-[10.5px] font-semibold text-emerald-100">
            <span className="flex items-center gap-1 truncate">
              <ArrowUpRight className="w-3 h-3" />
              {filteredData.inc.length} entries
            </span>
            <span className="px-1.5 py-0.5 rounded-md bg-white/20 text-[9px] sm:text-[9.5px] font-bold shrink-0">
              + Inflow
            </span>
          </div>
        </div>
        ...
        <div
          onClick={() => onNavigate('expenses')}
          className="relative overflow-hidden rounded-2xl p-3.5 sm:p-4 bg-gradient-to-br from-rose-600 via-pink-600 to-rose-700 text-white shadow-md shadow-rose-600/15 hover:shadow-lg hover:shadow-rose-600/25 transition-all duration-200 hover:-translate-y-1 cursor-pointer group flex flex-col justify-between min-h-[115px] sm:min-h-[120px]"
        >
          <div className="flex items-center justify-between mb-1.5">
          ...
          <div className="flex items-center justify-between pt-2 border-t border-white/15 text-[10px] sm:text-[10.5px] font-semibold text-rose-100">
            <span className="flex items-center gap-1 truncate">
        ...
        <div
          ...
          className="relative overflow-hidden rounded-2xl p-3.5 sm:p-4 bg-gradient-to-br from-indigo-600 via-blue-600 to-violet-700 text-white shadow-md shadow-indigo-600/15 hover:shadow-lg hover:shadow-indigo-600/25 transition-all duration-200 hover:-translate-y-1 cursor-pointer group flex flex-col justify-between min-h-[115px] sm:min-h-[120px]"
        >
          <div className="flex items-center justify-between mb-1.5">
          ...
          <div className="flex items-center justify-between pt-2 border-t border-white/15 text-[10px] sm:text-[10.5px] font-semibold text-indigo-100">
        ...
        <div
          ...
          className="relative overflow-hidden rounded-2xl p-3.5 sm:p-4 bg-gradient-to-br from-purple-700 via-violet-800 to-indigo-950 text-white shadow-md shadow-purple-700/20 hover:shadow-lg hover:shadow-purple-700/30 transition-all duration-200 hover:-translate-y-1 cursor-pointer group border border-purple-400/20 flex flex-col justify-between min-h-[115px] sm:min-h-[120px]"
        >
          <div className="flex items-center justify-between mb-1.5">
            <span className="text-[10px] font-black uppercase tracking-wider text-purple-200">
              Cash in Hand
            </span>
            <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-lg bg-white/15 backdrop-blur-xs flex items-center justify-center text-purple-200 border border-white/20">
          ...
          <div className="flex items-center justify-between pt-2 border-t border-white/15 text-[10px] sm:text-[10.5px] font-semibold text-purple-200">
            <span className="truncate">Office Drawer</span>
            <span className="px-1.5 py-0.5 rounded-md bg-purple-400/30 text-white text-[9px] sm:text-[9.5px] font-bold group-hover:bg-white group-hover:text-purple-900 transition-colors shrink-0">
              Adjust ⚙️
            </span>
          </div>
        </div>

        {/* CARD 5: ARIF VAI FUNDING (GOLD / AMBER - SPANS 2 COLS ON PHONE) */}
        <div
          onClick={() => onNavigate('funding')}
          className="col-span-2 md:col-span-1 relative overflow-hidden rounded-2xl p-3.5 sm:p-4 bg-gradient-to-br from-amber-500 via-orange-500 to-amber-700 text-white shadow-md shadow-amber-500/15 hover:shadow-lg hover:shadow-amber-500/25 transition-all duration-200 hover:-translate-y-1 cursor-pointer group flex flex-col justify-between min-h-[115px] sm:min-h-[120px]"
        >
          <div className="flex items-center justify-between mb-1.5">
          ...
          <div className="flex items-center justify-between pt-2 border-t border-white/15 text-[10px] sm:text-[10.5px] font-semibold text-amber-100">
